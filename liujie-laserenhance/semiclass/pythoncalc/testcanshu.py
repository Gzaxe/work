...
class CoulombPotentialParticle:
    ...
    def simulate(self, x0, p0, t_max, num_points=1000):
        """运行模拟"""
        y0 = np.array([x0, p0])
...
if __name__ == "__main__":
    # 创建模拟器实例
    simulator = CoulombPotentialParticle(k=2.3*10**(-28), m=2*10**(-27), q=1.0, Q=1.0)
    ...
    # 运行模拟
    t, x, p, energy = simulator.simulate(x0, p0, t_max=10**(-16), num_points=2000)
