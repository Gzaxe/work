...
class CoulombPotentialParticle:
    ...
    def equations_of_motion(self, t, y):
        """哈密顿方程"""
        x, p = y
        dxdt = p / self.m + 28.9176 * np.sin(151.859*t)
        dpdt = self.force(x)
...
if __name__ == "__main__":
    ...
    # 设置初始条件
    x0 = 3.68742898153647  # 初始位置
    p0 = -1.79852396070937 # 初始动量
    
    # 运行模拟
    t, x, p, energy = simulator.simulate(x0, p0, t_start=0.124125, t_max=1, num_points=2000)
...
# 保存为CSV
df.to_csv(save_dir + 'fig3-a-phase2.csv', index=False)
